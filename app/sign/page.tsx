...
function SignPage() {
  return (
    <div className="flex flex-col pt-47pxr pb-12pxr justify-between gap-27pxr w-full h-full">
      <div className="relative flex flex-auto flex-col gap-16pxr px-35pxr text-inputGreen">
        <p className="font-gowunBatang text-28pxr font-bold">
          여행의 모든 감동을
          <br />
          나만의 이야기로
          <br />
        ...
        <p className="font-gowunBatang text-18pxr">
          3초면 회원가입이 가능해요!
        </p>
